...
extern int	FDECL(xlate, (char *));
	//Moved these here to access the colormap from other files...
typedef struct MUX_COLORMAP {
  int i_dec;
  char *s_hex;
} MUXANSI;
#ifdef ZENTY_ANSI
#ifndef MUXCOLORMAPDEFINED
#define MUXCOLORMAPDEFINED
extern  struct MUX_COLORMAP mux_namecolors[257];
struct MUX_COLORMAP mux_namecolors[] = {
    {0, "000000"},
    {1, "800000"},
    {2, "008000"},
    {3, "808000"},
